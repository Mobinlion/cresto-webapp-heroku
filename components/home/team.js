...
const CardExampleCard = () => (
  <Container id="Team" right="true" role="region">
    <div className="container">
      <hr className="beautiful-line" />
    </div>
    <Container small center="true" padding="true">
      ...
      <Card.Group itemsPerRow={2} stackable={true}>
        ...
        <Card>
          ...
          <Card.Content>
            ...
            <Card.Description>
              ...
              fintech and blockchain compliance Conducted a few ICOs and STOs
              for real asset backed securities in different jurisdictions
            </Card.Description>
          </Card.Content>
          <Card.Content extra>
            <a>
        ...
        <Card>
          ...
          <Card.Content>
            ...
            <Card.Description>
              Co-Founder & CTO at OBORCHAIN Blockchain enthusiast and developer
              15 years of software development experience. Information security
        ...
        <Card>
          ...
          <Card.Content>
            ...
            <Card.Description>
              ...
              Blockchain, App development) Holds degrees in computer
              engineering, computer science and electronics & biotechnology
              White Hat Hacker.
            </Card.Description>
          </Card.Content>
          <Card.Content extra>
        ...
        <Card>
          ...
          <Card.Content>
            ...
            <Card.Description>
              ...
              University of California, Berkeley Financial engineer in hedge
              fund and investment backing.
            </Card.Description>
          </Card.Content>
          <Card.Content extra>
            <a>
        ...
        <Card>
          ...
          <Card.Content>
            ...
            <Card.Description>
              ...
              Above 7 years of experience in real estate investments,
              development projects & asset management EIBS MBA & CFA level 3.
            </Card.Description>
          </Card.Content>
          <Card.Content extra>
            <a>
