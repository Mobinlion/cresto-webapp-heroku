...
const DEMO_DATA = {
  Invest: require('./demos/file-system-routing').default,
  'Why and How to Invest?': require('./demos/code-splitting').default,
  'Raise Capital': require('./demos/ssr').default,
  'Why and How to Raise Capital?': require('./demos/static-exporting').default
};
